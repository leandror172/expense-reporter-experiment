...
func TestLoadTaxonomy_SkeletonOnly(t *testing.T) {
	taxonomyPath := "../../../expense-reporter/test/fixtures/generate-basic/taxonomy.json"
...
func TestLoadTaxonomy_WithEntries(t *testing.T) {
	taxonomyPath := "../../../expense-reporter/test/fixtures/generate-basic/taxonomy.json"
	entriesPath := "../../../expense-reporter/test/fixtures/generate-basic/entries.jsonl"
...
func TestLoadTaxonomy_UnmappedSubcategory(t *testing.T) {
	taxonomyPath := "../../../expense-reporter/test/fixtures/generate-basic/taxonomy.json"
	entriesPath := "../../../expense-reporter/test/fixtures/generate-basic/entries-with-unmapped.jsonl"
